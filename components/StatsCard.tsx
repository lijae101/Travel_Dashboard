    ...
    return (
        <article className='stats-card'>
            ...
            <div className='content'>
                <div className='flex flex-col gap-4'>
                    ...
                    <div className='flex items-center gap-2'>
                        <figure className='flex items-center gap-1'>
                            <img src={`/assets/icons/${isDecrement ? 'arrow-down-red' : 'arrow-up-green'}.svg`} alt="arrow" className='size-5' />
                ...
                <img src={`/assets/icons/${isDecrement ? 'decrement.svg' : 'increment.svg'}`} alt="trend icon"
